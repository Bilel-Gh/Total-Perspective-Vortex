...
def load_subject_data(subject_id, data_path):
    """
    Charge les données prétraitées pour un sujet et extrait
...
def create_pipeline():
    """
    Crée un pipeline de traitement avec réduction de dimensionnalité
     et classification.
    """
    ...
    pipeline = Pipeline([
        ...
        ('dimensionality_reduction', MyPCA(n_components=12)),  # Ta version
        # de PCA
...
if __name__ == "__main__":
    ...
    print("Modèle entraîné sauvegardé avec succès!")
